...
const steps=[
  ...
  {icon:MousePointerClick,title:'3. 날짜를 눌러 크게 보기',text:'휴대폰 위쪽의 간단한 달력에서 날짜를 누르세요. 바로 아래에 그날의 근무와 ‘이날 근무 바꾸기’ 버튼이 나옵니다. ‘달력 보기’는 날짜 선택으로, ‘근무표 보기’는 아래쪽 전체 근무표로 바로 이동합니다. 전체 표는 좌우로 밀어 볼 수 있습니다. ‘오늘’을 누르면 오늘 날짜를 선택합니다. 느낌표(!)가 있는 날은 배치를 확인해 주세요.'},
...
const setupSteps=[
  ...
  {icon:Settings2,title:'4. 지난달 마지막 날 근무 확인',text:'다시 ‘근무자·휴무 설정’을 열고 아래의 ‘지난달 마지막 날 / 다음 달 첫날 근무’을 찾으세요. 각 사람의 ‘지난달 말일’에는 지난달 마지막 날의 실제 근무를 넣습니다. ‘다음 달 1일’도 정해져 있다면 입력하세요. 모르는 값은 ‘미확인’으로 두고, 최종 사용 전에 확인하세요. 야간 근무 바로 다음 날 주간 근무가 잡히는 것을 막기 위한 확인입니다.'},
...
const editSteps=[
  {icon:MousePointerClick,title:'하루 근무를 바꾸려면',text:'달력의 날짜를 누르세요. 휴대폰은 아래에 나오는 그날의 상세 화면에서 ‘이날 근무 바꾸기’을 한 번 더 누릅니다. 바꿀 사람 이름 옆의 선택 상자를 눌러 주간·야간 근무지 또는 휴무를 고르세요. 다른 사람이 이미 맡은 자리라면, 기존 담당자를 먼저 휴무로 바꾸고 새 담당자를 배치하세요. 끝나면 ‘점검’ 후 ‘근무표 저장’을 누릅니다.'},
  {icon:CalendarDays,title:'연가를 넣으려면',text:'먼저 자동 편성으로 근무표를 만드세요. ‘개인별 보기’에서 해당 이름을 누르고 ‘연가 신청’에서 날짜를 골라 ‘연가 등록’을 누릅니다. 인원 부족으로 등록이 안 되면 해당 날짜의 이날 근무 바꾸기에서 연가를 쓸 사람을 휴무로 바꾸고 대체자를 배치한 뒤 다시 등록하세요. 정기휴무일에는 연가를 중복 등록할 수 없습니다. 마지막에 ‘근무표 저장’을 누르세요.'},
