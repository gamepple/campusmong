...
const editSteps=[
  {icon:MousePointerClick,title:'하루 근무를 바꾸려면',text:'달력의 날짜를 누르세요. 휴대폰은 아래에 나오는 그날의 상세 화면에서 ‘이날 근무 바꾸기’를 한 번 더 누릅니다. 바꿀 사람 이름 옆의 선택 상자를 눌러 주간·야간 근무지 또는 휴무를 고르세요. 정문·후문 같은 근무지를 직접 누르면 배치 가능한 근무자가 나옵니다. 이름을 누르면 바로 배치되고, 다른 자리에서 일하던 분이면 기존 담당자와 서로 자리를 바꿉니다. 휴무 중인 분을 고르면 기존 담당자는 휴무가 됩니다. 회색 항목에는 배치 불가 이유가 표시됩니다. 끝나면 ‘점검’ 후 ‘근무표 저장’을 누릅니다.'},
