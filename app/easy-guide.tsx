...
const setupSteps=[
  ...
  {icon:Settings2,title:'3. 근무자와 쉬는 요일 설정',text:'휴대폰에서는 ‘설정’, 컴퓨터에서는 왼쪽 ‘편성 기준’을 누르세요. ‘근무자 관리’에서 이름을 누르면 이름, 주간 전담·야간 근무, 정기휴무를 바꿀 수 있습니다. 매주 쉬는 요일을 정확히 2개 선택하고 ‘개인 설정 적용’을 누르세요. 다른 분들도 같은 방법으로 설정합니다. 주간 전담자는 2명으로 맞춰 주세요.'},
  {icon:Settings2,title:'4. 지난달 마지막 날 근무 확인',text:'다시 ‘설정’ 또는 ‘편성 기준’을 열고 아래의 ‘월 경계 근무 확인’을 찾으세요. 각 사람의 ‘전월 말’에는 지난달 마지막 날의 실제 근무를 넣습니다. ‘다음 달 1일’도 정해져 있다면 입력하세요. 모르는 값은 ‘미확인’으로 두고, 최종 사용 전에 확인하세요. 야간 근무 바로 다음 날 주간 근무가 잡히는 것을 막기 위한 확인입니다.'},
  {icon:WandSparkles,title:'5. 자동으로 한 달 초안 만들기',text:'설정 창을 닫고 ‘자동 편성’ → ‘초안 만들기’를 누르세요. 정기휴무를 참고해 한 달 근무표가 만들어집니다. 빈자리가 남을 수 있으니 다음 단계에서 확인하세요. 이미 작성한 달에서 다시 누르면 그달의 기존 배치가 새로 만들어집니다.'},
  ...
  {icon:Save,title:'7. 마지막에 근무표 저장',text:'‘근무표 저장’을 누르고 ‘근무표를 저장했습니다.’라는 알림이 나오는지 확인하세요. 휴대폰은 화면 아래, 컴퓨터는 위쪽에 저장 버튼이 있습니다. ‘개인 설정 적용’만 누르면 저장은 끝나지 않습니다. 저장 실패 안내가 나오면 화면을 닫지 말고, 안내된 문제를 해결한 뒤 다시 저장하세요.'},
];
const editSteps=[
  {icon:MousePointerClick,title:'하루 근무를 바꾸려면',text:'달력의 날짜를 누르세요. 휴대폰은 아래에 나오는 그날의 상세 화면에서 ‘배치 편집’을 한 번 더 누릅니다. 바꿀 사람 이름 옆의 선택 상자를 눌러 주간·야간 근무지 또는 휴무를 고르세요. 다른 사람이 이미 맡은 자리라면, 기존 담당자를 먼저 휴무로 바꾸고 새 담당자를 배치하세요. 끝나면 ‘점검’ 후 ‘근무표 저장’을 누릅니다.'},
  {icon:CalendarDays,title:'연가를 넣으려면',text:'먼저 자동 편성으로 근무표를 만드세요. ‘개인별 보기’에서 해당 이름을 누르고 ‘연가 신청’에서 날짜를 골라 ‘연가 등록’을 누릅니다. 인원 부족으로 등록이 안 되면 해당 날짜의 배치 편집에서 연가를 쓸 사람을 휴무로 바꾸고 대체자를 배치한 뒤 다시 등록하세요. 정기휴무일에는 연가를 중복 등록할 수 없습니다. 마지막에 ‘근무표 저장’을 누르세요.'},
  {icon:Settings2,title:'근무자가 새로 오셨다면',text:'‘설정’ 또는 ‘편성 기준’의 ‘근무자 추가’에서 이름과 근무 구분을 고르고 ‘추가’를 누르세요. 새로 추가한 분은 토·일이 정기휴무로 되어 있으니 이름을 눌러 실제 쉬는 요일로 바꾸세요. 기존 근무표에 필요한 배치를 확인한 뒤 저장하세요.'},
